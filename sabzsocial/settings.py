...
SECRET_KEY = 'django-insecure-u6&rz9^@@(s!dv79tyf@qpa#b3br2%o&un4fvxe)n$58rvhlz+'
...
EMAIL_HOST_USER = 'mohsendarabi20003@gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
# Use for Default User model(get_absolute_url)
